...
def plot_segmap_ellpreds(image, seg_map, pupil_ellipse, iris_ellipse):
    ...
    cv2.ellipse(out_image, (int(iris_ellipse[0]), int(iris_ellipse[1])), (int(iris_ellipse[2]), int(iris_ellipse[3])),
                iris_ellipse[4] / 3.14159 * 180, 0, 360, (255, 0, 0), 1, cv2.LINE_AA)  # 画椭圆
    cv2.ellipse(out_image, (int(pupil_ellipse[0]), int(pupil_ellipse[1])), (int(pupil_ellipse[2]), int(pupil_ellipse[3])),
                pupil_ellipse[4] / 3.14159 * 180, 0, 360, (0, 0, 255), 1, cv2.LINE_AA)  # 画椭圆
