...
def parse_args():
    ...
    parser.add_argument('--record_iou', type=int, default=0, help='test whethre is normal')
    parser.add_argument('--record_img', type=int, default=0, help='test whethre is normal')
    parser.add_argument('--iou_filename', type=str, default='test.pkl', help='test whethre is normal')
    parser.add_argument('--visual_dir', type=str, default='iris', help=' 0 -> iris, 1 -> pupil')
